...
class Julia2018AdvancedTouchUI(octoprint.plugin.StartupPlugin):
	...
	def get_update_information(self):
		return dict(
			Julia2018AdvancedTouchUI=dict(
				displayName="Julia2018AdvancedTouchUI",
				displayVersion=self._plugin_version,
				# version check: github repository
				type="github_release",
				user="FracktalWorks",
				repo="Julia2018AdvancedTouchUI",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/FracktalWorks/Julia2018AdvancedTouchUI/archive/{target_version}.zip"
			)
		)


__plugin_name__ = "Julia2018AdvancedTouchUI"
__plugin_version__ = "1.0.4"


def __plugin_load__():
	global __plugin_implementation__
	__plugin_implementation__ = Julia2018AdvancedTouchUI()
